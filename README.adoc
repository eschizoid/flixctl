...
of this architecture allows an easy installation of the full `flixctl` API into any Slack workspace. Meaning the provisioning
and administration of a true true MaSaS (Movies and Show as a Service) architecture can be done using only Slack.
