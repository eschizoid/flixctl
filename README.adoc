...
Available Commands:
  archive     To Archive Movies Or Shows
  catalogue   To Get Movies And Shows Catalogue
  initiate    To Initiate Library Catalogue Retrieval
  jobs        To List Library Jobs
  retrieve    To Retrieve Movies Or Shows
